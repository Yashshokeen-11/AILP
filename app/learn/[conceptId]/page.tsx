...
// Mock learning content - in real app, this would be generated by the teaching service
const learningContent: Record<string, {
  ...
  operations: {
    ...
    sections: [
      {
        type: 'introduction',
        content: `Let's explore how Python handles numbers and basic calculations. Think of Python as a very precise calculator that can remember things.

Before we dive into code, let's build an intuition: when you go shopping and calculate the total cost, you're doing operations. You add prices, maybe calculate tax, perhaps figure out change. Python does the same thing, but it can do it millions of times without getting tired.`
      },
      {
        type: 'concept',
        content: `**Addition and Subtraction**

In Python, adding numbers is as natural as it sounds:
...
Notice the \`#\` symbol? That's a comment—Python ignores everything after it. Comments are notes for humans, not instructions for Python.`
      },
      {
        type: 'checkpoint',
        question: 'Why might adding comments to your code be useful, even though Python ignores them?',
        hint: 'Think about coming back to your code a month later...'
      },
      {
        type: 'concept',
...
Notice something interesting? Even though 10 divided by 2 is exactly 5, Python gives us \`5.0\`. This is because division in Python always produces a decimal number (called a "float").`
      },
      {
        type: 'analogy',
        content: `**An Analogy**

Think of Python's number system like sorting coins:

- **Integers** (whole numbers) are like counting bills: 1, 2, 3, 100
- **Floats** (decimal numbers) are like measuring exact amounts: 3.14, 2.5, 5.0

When you divide, Python assumes you want precision, so it gives you a float, just like using a scale instead of counting items.`
      },
      {
        type: 'checkpoint',
        question: 'If you wanted to divide 15 by 4 and only get the whole number part (ignoring the remainder), what do you think you might do?',
        hint: 'Python has a special operator for this: //'
      },
      {
        type: 'concept',
        content: `**Order of Operations**

Python follows the same mathematical rules you learned in school (PEMDAS):
...
The parentheses tell Python "do this part first." Without them, multiplication happens before addition.`
      },
      {
        type: 'reflection',
        content: `Take a moment to think: You've now learned the fundamental building blocks of calculation. Every complex program, from video games to scientific simulations, ultimately breaks down into these simple operations repeated millions of times.`
      }
    ]
  }
};
    ...
    return (
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl text-neutral-900 mb-4">Content not found</h1>
                  ...
                  {showCheckpointFeedback && (
                    <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                      <p className="text-emerald-900">
                        Great thinking! This kind of reflection is key to deep understanding.
                        Comments help you (and others) understand your code's purpose when you
                        return to it later.
                      </p>
                    </div>
                  )}
